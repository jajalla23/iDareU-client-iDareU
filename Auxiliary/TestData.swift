...
class TestData {
    public static func generateUser() -> User {
        ...
        let challenge1: Challenge = Challenge.init(ownerId: user.id!, title: "Challenge1", description: "Completed Challenge", reward: 10)
        let challenge2: Challenge = Challenge.init(ownerId: user.id!, title: "Challenge2", description: "Pending Challenge", reward: 20)
        let challenge3: Challenge = Challenge.init(ownerId: user.id!, title: "Challenge3", description: "Owned Challenge", reward: 30)
        let challenge4: Challenge = Challenge.init(ownerId: user.id!, title: "Challenge4", description: "Pending Challenge", reward: 20)
        ...
        user.addToChallengesOwned(challenge: challenge3)
